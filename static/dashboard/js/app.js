                ...
                <div class="ui fluid card" id="instance-card-${instance.id}">
                    ...
                    <div class="extra content">
                        <div class="ui two buttons">
                            ...
                            <button class="ui circular icon button negative" data-tooltip="Apagar" data-position="top center" onclick="deleteInstance('${instance.id}')">
                                <i class="trash alternate icon"></i>
                            </button>
                            <button class="ui circular icon button green" data-tooltip="Iniciar" data-position="top center">
                                <i class="play icon"></i>
                            </button>
                            <button class="ui circular icon button orange" data-tooltip="Reiniciar" data-position="top center">
                                <i class="sync icon"></i>
                            </button>
                            <button class="ui circular icon button blue" data-tooltip="Gerar QRCode" data-position="top center">
                                <i class="qrcode icon"></i>
                            </button>
                            <button class="ui circular icon button purple" data-tooltip="Gerar Pair Code" data-position="top center">
